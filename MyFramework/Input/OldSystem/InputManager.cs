...
namespace MyFramework.InputUnit.OldSystem
{
    public class InputMgr : BaseManager<InputMgr>
    {
        ...
        private readonly Dictionary<BroadcastEventType, InputInfo> inputDic = new();
        ...
        public void ChangeKeyboardInfo(BroadcastEventType eventType, KeyCode key, InputInfo.E_InputType inputType)
        {
            //初始化
        ...
        /// <param name="inputType"></param>
        public void ChangeMouseInfo(BroadcastEventType eventType, int mouseID, InputInfo.E_InputType inputType)
        {
            //初始化
            if (!inputDic.ContainsKey(eventType))
            {
        ...
        /// </summary>
        /// <param name="eventType"></param>
        public void RemoveInputInfo(BroadcastEventType eventType)
        {
            if (inputDic.ContainsKey(eventType))
        ...
        private void InputUpdate()
        {
            ...
            foreach (BroadcastEventType eventType in inputDic.Keys)
            {
                    ...
                    switch (nowInputInfo.inputType)
                    {
                        case InputInfo.E_InputType.Down:
                            if (Input.GetKeyDown(nowInputInfo.key))
                                BroadcastCenter.Broadcast(eventType);
                            break;
